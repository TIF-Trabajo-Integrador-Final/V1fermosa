...
class SedeSeeder extends Seeder
{
    ...
    {
        $now = Carbon::now(); // Obtenemos la fecha y hora actual
        ...
        DB::table('sedes')->insert([
            [
                ...
                'latitud' => -26.1775300, // <-- Coordenada de Formosa
                'longitud' => -58.1741300, // <-- Coordenada de Formosa
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'latitud' => -25.296880, // <-- Coordenada de Asunción
                'longitud' => -57.573510, // <-- Coordenada de Asunción
                'created_at' => $now,
                'updated_at' => $now,
            ]
        ]);
