...
<div id="chat-window" 
     class="fixed bottom-24 right-6 
            ...
            transform scale-0 origin-bottom-right transition-transform duration-300
    ...
    <div class="bg-[#131567] p-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center border border-[#131567]/40 shadow">
    ...
    <div id="chat-messages" 
     class="h-48 overflow-y-auto p-3 bg-[#f4f5f7] space-y-2 text-[13px] leading-snug">
        ...
        <div class="flex items-start gap-3 animate-fade-in-up">
            ...
            <div class="bg-white p-3 rounded-xl shadow-sm text-sm text-gray-700 max-w-[85%] border border-gray-200 leading-relaxed">
                <strong class="text-[#131567]">¡Hola! 😊</strong><br>
                Para comenzar escribí: <strong>"Hola soy tu nombre"</strong><br><br>
                Ejemplo: <strong>Hola soy María</strong>
            </div>
        </div>
    </div>
    ...
    <div class="p-3 bg-white border-t border-gray-100">
        <form id="chat-form" onsubmit="handleUserMessage(event)" class="flex gap-2">
            ...
            <button type="submit" 
                    class="bg-[#131567] text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-900 transition">
...
<script>
    ...
    function handleUserMessage(e) {
        ...
        setTimeout(() => {
            ...
            if (lower.startsWith("hola")) {
                ...
                addMessage(`
                    Hola <strong>${name}</strong> 😊 ¿En qué puedo ayudarte?<br><br>
                    Escribí <strong>"Opciones"</strong> para ver el menú.
                `, 'bot', true);
            ...
            addMessage(`
                ...
                Para comenzar escribí <strong>"Hola soy tu nombre"</strong>.<br>
    ...
    function showMenu() {
        addMessage(`
            <p>Elegí una opción para hablar con un asesor por WhatsApp:</p>
            <div class="flex flex-col gap-2 mt-2">

                <button onclick="redirectToWsp('Hola, necesito información sobre Aranceles.')"
                    class="bg-[#131567] text-white text-sm py-2 px-3 rounded-lg hover:bg-blue-900 shadow-md flex justify-between">
                    📝 Aranceles <i class="fab fa-whatsapp"></i>
                </button>

                <button onclick="redirectToWsp('Hola, quiero información sobre Inscripciones.')"
                    class="bg-[#131567] text-white text-sm py-2 px-3 rounded-lg hover:bg-blue-900 shadow-md flex justify-between">
    ...
    function addMessage(text, sender, html = false) {
        ...
        const bubble = sender === 'user'
            ? 'bg-[#131567] text-white rounded-xl rounded-bl-none'
            : 'bg-white border border-gray-200 text-gray-700 rounded-xl rounded-tl-none';

        div.innerHTML = `
            <div class="${bubble} p-3 shadow-sm text-sm max-w-[85%] leading-relaxed font-montserrat">
                ${html ? text : text}
            </div>
        `;
